...
class TournamentPlayersForm extends StatefulWidget {
  final String mode;
  ...
  @override
  State<TournamentPlayersForm> createState() => _TournamentPlayersFormState();
}

class _TournamentPlayersFormState extends State<TournamentPlayersForm> {
